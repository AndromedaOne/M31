 ...
 *
 */
public class GetInPositionLeft extends CommandGroup {

    public GetInPositionLeft() {
        // Add Commands here:
    	...
    	//Robot should face towards other team
    	...
    	addSequential(new TurnToCompassHeading(330));
    }
}
