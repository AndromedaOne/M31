...
public class RobotMap {
    ...
    public static CANTalon ballShootershooterMotor;
    public static Ultrasonic ultraSonicUltrasonic1;
    ...
    public static void init() {
        ...
        ballShootershooterMotor = new CANTalon(6);
        LiveWindow.addActuator("ballShooter", "shooterMotor", ballShootershooterMotor);
        
        ultraSonicUltrasonic1 = new Ultrasonic(6, 7);
        LiveWindow.addSensor("UltraSonic", "Ultrasonic1", ultraSonicUltrasonic1);
        

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        m_navxGyro = new NavxGyro();
        LiveWindow.addSensor("DriveTrain", "NavxGyro", NavxGyro.getAHRS());
