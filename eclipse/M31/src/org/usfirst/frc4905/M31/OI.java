...
public class OI {
    ...
    public JoystickButton openHandler;
	...
	public OI() {
        ...
        openHandler = new JoystickButton(subController, 2);
        openHandler.whenReleased(new openGearHandler());
		...
		SmartDashboard.putData("TurnToDegreeAngle", new TurnToDegreeAngle(40));
		...
		toggleButton.whenPressed(new RunIntake());
