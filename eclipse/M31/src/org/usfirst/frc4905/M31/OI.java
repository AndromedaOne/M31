...
public class OI {
    ...
    public JoystickButton ballShootButton;
    ...
    public OI() {
        ...
        ballShootButton = new JoystickButton(driveController, 3);
        ballShootButton.whileHeld(new shootBall());
        ...
        SmartDashboard.putData("movePastLine", new movePastLine());
        SmartDashboard.putData("rotateWithEncoder", new rotateWithEncoder());
