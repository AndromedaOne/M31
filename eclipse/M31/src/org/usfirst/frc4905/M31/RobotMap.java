...
public class RobotMap {
    ...
    public static Encoder omniWheelEncoder;
	...
	public static void init() {
       ...
       omniWheelEncoder = new Encoder(11, 12, false);
       LiveWindow.addSensor("DriveTrain", "OmniWheelEncoder", omniWheelEncoder);
       //gear handler (new!)
       ...
       redVal = new PWM(13);
       LiveWindow.addActuator("LEDS", "Red", redVal);
       blueVal = new PWM(14);
       LiveWindow.addActuator("LEDS", "Blue", blueVal);
       greenVal = new PWM(15);
       LiveWindow.addActuator("LEDS", "Green", greenVal);
	}
