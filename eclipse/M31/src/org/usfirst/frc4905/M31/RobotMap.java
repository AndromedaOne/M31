...
public class RobotMap {
	...
	private static UltrasonicSubsystem m_ultrasonicFront;
    ...
    public static AnalogPotentiometer shooterPot;
    public static VictorSP aimServo;
	public static void init() {
       ...
       shooterPot = new AnalogPotentiometer(0);
       LiveWindow.addActuator("Shooter", "Shooter Pot", shooterPot);
       
       aimServo = new VictorSP(4);
       LiveWindow.addActuator("Shooter", "Shooter Servo", aimServo);
	...
	public static UltrasonicSubsystem getUltrasonicFront(){
